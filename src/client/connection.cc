 ...
 *
 */
void RestClient::Connection::SetFileProgressCallback(curl_progress_callback
                                                         progressFn)
{
 ...
 *
 */
void RestClient::Connection::SetUnixSocketPath(const std::string &unixSocketPath)
{
 ...
 *
 */
void RestClient::Connection::SetWriteFunction(RestClient::WriteCallback
                                                  writeCallback)
{
                                           ...
                                           RestClient::Response *ret)
{
  ...
  if (!this->verifyPeer)
  {
    curl_easy_setopt(getCurlHandle(), CURLOPT_SSL_VERIFYPEER,
                     this->verifyPeer);
    curl_easy_setopt(getCurlHandle(), CURLOPT_SSL_VERIFYHOST, 0);
  }
  ...
  // debug
  // curl_easy_setopt(getCurlHandle(), CURLOPT_VERBOSE, 1);
